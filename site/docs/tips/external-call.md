...
Calling `zk` from other programs can be useful in a number of situations, such
as:
...
- automating periodical maintenance tasks on your
  [notebook](../notes/notebook.md)
- displaying the backlinks of a note in a GUI wrapper around `zk`

The following options can be useful to make sure `zk` behaves properly in a
background context:
